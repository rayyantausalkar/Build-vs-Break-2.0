...
const DIRECTIVES: Directive[] = [
  {
    ...
    accent: "violet",
    accentColor: "#8B7CF6",
    tag: "QUIZ QUALIFIER · 30 TEAMS",
    axiom: "Shortlisting is determined by the preliminary Quiz Round. Exactly 30 qualifying teams advance to the 3rd October main arena.",
  },
  {
    id: "d2",
    num: "02",
    ...
    accent: "ember",
    accentColor: "#C4642E",
    tag: "15 PROBLEM STATEMENTS (FCFS)",
    axiom: "15 official Problem Statements released on event morning. Selection operates strictly on a First-Come, First-Served basis.",
  },
  {
    id: "d3",
    num: "03",
    ...
    accent: "violet",
    accentColor: "#8B7CF6",
    tag: "1V1 RIVAL MATCHUPS",
    axiom: "Two squads choosing the identical Problem Statement become direct opponents pitted in a head-to-head engineering duel.",
  },
  {
    id: "d4",
    num: "04",
    ...
    accent: "violet",
    accentColor: "#8B7CF6",
    tag: "ROUND 1 · BUILD SOLUTION",
    axiom: "Build live from scratch. Each squad develops their complete working solution before the 1-hour lunch break.",
  },
  {
    id: "d5",
    num: "05",
    ...
    accent: "ember",
    accentColor: "#C4642E",
    tag: "ROUND 2 · CRACK & CHALLENGE",
    axiom: "Teams receive 30 minutes to dissect their opponent's project and identify architectural gaps, flaws, and failure points.",
  },
  {
    id: "d6",
    num: "06",
    ...
    accent: "ember",
    accentColor: "#C4642E",
    tag: "PITCH & CROSS-EXAMINATION",
    axiom: "Pitch your solution to the judges, then present your opponent's flaws and loopholes to demonstrate why your solution wins.",
  },
];
...
export default function Rules() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-20 top-20 h-96 w-96 rounded-full bg-[#8B7CF6]/10 blur-[60px] sm:blur-[130px]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-20 bottom-20 h-96 w-96 rounded-full bg-[#C4642E]/10 blur-[60px] sm:blur-[130px]"
      />
          ...
          {DIRECTIVES.map((d, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative flex flex-col justify-between overflow-hidden rounded-2xl sm:rounded-3xl p-5 sm:p-7 backdrop-blur-sm sm:backdrop-blur-xl transition-all duration-500 cursor-pointer select-none border ${
                  isHovered
                    ? isViolet
